...
**Template variables:** If any `<variable>` placeholder in this document was not replaced during setup, treat that check as **not applicable** and skip it. Note skipped checks in the report.
