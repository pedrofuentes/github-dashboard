...
>
> **4. Audit delegation (anti-collapse).** From the `PLAN.md` delegation ledger, confirm recent increments/artifacts have **producer ≠ reviewer**; if the Lead has silently collapsed into authoring *and* reviewing the work solo (or no sub-agents are being used), flag a WARNING and re-delegate — operating as a fleet is required.
>
